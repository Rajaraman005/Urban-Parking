...
comment on column public.parking_spaces.available_from_date is
  'First date the host wants the space to appear as bookable.';
comment on column public.parking_spaces.available_to_date is
  'Last date included in the host booking window.';
comment on column public.parking_spaces.daily_start_minute is
  'Start of the daily booking window in minutes after midnight, Asia/Kolkata.';
comment on column public.parking_spaces.daily_end_minute is
  'End of the daily booking window in minutes after midnight, Asia/Kolkata.';
